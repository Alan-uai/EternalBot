...
export async function execute(interaction) {
    ...
    // Se um usuário é especificado, apenas mostra o perfil dele.
    if (targetUser) {
        ...
        try {
            ...
            console.error("Erro ao criar imagem de perfil no /iniciar-perfil (modo visualização):", e);
    ...
    const row = new ActionRowBuilder()
        .addComponents(
            new ButtonBuilder()
                ...
                .setLabel('Criar / Atualizar Perfil')
