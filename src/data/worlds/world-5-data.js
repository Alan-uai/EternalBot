...
export const world5Data = {
  ...
  npcs: [
    ...
    { name: 'Rangaki', rank: 'SS', exp: 300000, hp: '31.2de', drops: { coins: { amount: 'x7M', probability: 1 }, 'Demon Arts Token': { amount: 'x3-5', probability: 0.1 }, 'Breathing Token': { amount: 'x3-5', probability: 0.1 }, avatar_soul: { amount: 1, probability: 0.5 }, aura: { name: 'Flaming Aura', probability: 0.05 }, avatar: { probability: 0.01 } }, videoUrl: 'https://cdn.discordapp.com/attachments/1430337273794265250/1430337846912221314/ScreenRecording_10-21-2025_10-31-41_1.mov?ex=68fa122d&is=68f8c0ad&hm=8c251843f5a6cef356551f7f8e66c564aaf4dab8be019d1c30e824ac3fdb40a7&' },
  ],
  pets: [
    { name: 'Nazuki', rarity: 'Comum', energy_bonus: '0.05x' },
    { name: 'Tenjaro', rarity: 'Incomum', energy_bonus: '0.10x' },
    { name: 'Zentsu', rarity: 'Raro', energy_bonus: '0.15x' },
  ],
  powers: [
    {
      name: 'Demon Arts',
