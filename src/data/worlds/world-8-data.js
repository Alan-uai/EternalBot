...
export const world8Data = {
  ...
  npcs: [
    ...
    { name: 'Madera', rank: 'SS', hp: '5.64QnD', drops: { coins: { amount: 'x70B', probability: 1 }, 'Chakra Token': { amount: 'x3-5', probability: 0.1 }, 'Eye Token': { amount: 'x3-5', probability: 0.1 }, exp: { amount: 'x2.88k', probability: 1 }, avatar_soul: { amount: 1, probability: 0.5 }, 'shadow:madera': { probability: 1 }, shadow_soul: { amount: 1, probability: 0.5 }, shinobi_flops: { probability: 0.25 }, leafy_aura: { probability: 0.01 } }, videoUrl: 'https://cdn.discordapp.com/attachments/1430337273794265250/1430338462162092093/ScreenRecording_10-21-2025_10-36-50_1.mov?ex=68fa12bf&is=68f8c13f&hm=6608bd1a66e65473faf5d3e05f279e8187d991512894aa533f07cf185ee2525e&' },
  ],
  powers: [
    {
      name: 'Poder Ninja',
