...
export const world2Data = {
  ...
  npcs: [
    { name: 'Nomi', rank: 'E', exp: 150, hp: '4.5B', drops: { coins: { amount: 'x500', probability: 1 }, 'Pirate Crew Token': { amount: 'x1-5', probability: 0.1 }, 'Sword Token': { amount: 'x1-5', probability: 0.1 }, 'Haki Token': { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x9', probability: 1 }, avatar: { probability: 0.01 } } },
    { name: 'Usup', rank: 'D', exp: 250, hp: '70B', drops: { coins: { amount: 'x1k', probability: 1 }, 'Pirate Crew Token': { amount: 'x1-5', probability: 0.1 }, 'Sword Token': { amount: 'x1-5', probability: 0.1 }, 'Haki Token': { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x10', probability: 1 }, avatar: { probability: 0.01 } } },
    { name: 'Robins', rank: 'C', exp: 400, hp: '250B', drops: { coins: { amount: 'x1.5k', probability: 1 }, 'Pirate Crew Token': { amount: 'x1-5', probability: 0.1 }, 'Sword Token': { amount: 'x1-5', probability: 0.1 }, 'Haki Token': { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x11', probability: 1 }, avatar: { probability: 0.01 } } },
    { name: 'Senji', rank: 'B', exp: 600, hp: '1.2T', drops: { coins: { amount: 'x2k', probability: 1 }, 'Pirate Crew Token': { amount: 'x1-5', probability: 0.1 }, 'Sword Token': { amount: 'x1-5', probability: 0.1 }, 'Haki Token': { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x12', probability: 1 }, avatar: { probability: 0.01 } } },
    { name: 'Zaro', rank: 'A', exp: 850, hp: '12T', drops: { coins: { amount: 'x2.5k', probability: 1 }, 'Demon Fruit Token': { amount: 'x1-5', probability: 0.1 }, 'Sword Token': { amount: 'x1-5', probability: 0.1 }, 'Haki Token': { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x13', probability: 1 }, avatar: { probability: 0.01 } } },
    { name: 'Loffy', rank: 'S', exp: 1200, hp: '120T', drops: { coins: { amount: 'x3k', probability: 1 }, 'Demon Fruit Token': { amount: 'x1-5', probability: 0.1 }, 'Sword Token': { amount: 'x1-5', probability: 0.1 }, 'Haki Token': { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x14', probability: 1 }, avatar: { probability: 0.01 } } },
