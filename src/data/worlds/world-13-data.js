...
export const world13Data = {
  ...
  pets: [
    { name: 'Hawk', rank: 'Comum', rarity: 'Comum', energy_bonus: '0.13x' },
    { name: 'Fada', rank: 'Incomum', rarity: 'Incomum', energy_bonus: '0.26x' },
    { name: 'Cachorro Demônio', rank: 'Raro', rarity: 'Raro', energy_bonus: '0.39x' },
  ],
  powers: [
    {
