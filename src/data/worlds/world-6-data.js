...
export const world6Data = {
  ...
  npcs: [
    { name: 'Weak Sung', rank: 'E', exp: 119, hp: '625Sp', drops: { coins: { amount: 'x5M', probability: 1 }, 'Hunter Rank Token': { amount: 'x1-5', probability: 0.1 }, avatar_soul: { amount: 1, probability: 0.1 }, shadow_soul: { amount: 1, probability: 0.1 } } },
    { name: 'Green Goblin', rank: 'D', exp: 131, hp: '3.12O', drops: { coins: { amount: 'x10M', probability: 1 }, 'Hunter Rank Token': { amount: 'x1-5', probability: 0.1 }, avatar_soul: { amount: 1, probability: 0.11 }, shadow_soul: { amount: 1, probability: 0.11 } } },
    { name: 'White Tiger', rank: 'C', exp: 144, hp: '15.6O', drops: { coins: { amount: 'x15M', probability: 1 }, 'Hunter Rank Token': { amount: 'x1-5', probability: 0.1 }, avatar_soul: { amount: 1, probability: 0.125 }, shadow_soul: { amount: 1, probability: 0.125 } } },
    { name: 'Cha', rank: 'B', exp: 159, hp: '78O', drops: { coins: { amount: 'x20M', probability: 1 }, 'Hunter Rank Token': { amount: 'x1-5', probability: 0.1 }, 'ReAwakening Token': { amount: 'x1-5', probability: 0.1 }, avatar_soul: { amount: 1, probability: 0.15 }, shadow_soul: { amount: 1, probability: 0.15 } } },
    { name: 'Choi', rank: 'A', exp: 174, hp: '3.91N', drops: { coins: { amount: 'x25M', probability: 1 }, 'Hunter Rank Token': { amount: 'x1-5', probability: 0.1 }, 'ReAwakening Token': { amount: 'x1-5', probability: 0.1 }, 'Monarch Token': { amount: 'x1-5', probability: 0.1 }, avatar_soul: { amount: 1, probability: 0.2 }, shadow_soul: { amount: 1, probability: 0.2 } } },
    { name: 'Solo Sung', rank: 'S', exp: 192, hp: '1.95N', drops: { coins: { amount: 'x30M', probability: 1 }, 'Hunter Rank Token': { amount: 'x1-5', probability: 0.1 }, 'ReAwakening Token': { amount: 'x1-5', probability: 0.1 }, 'Monarch Token': { amount: 'x1-5', probability: 0.1 }, avatar_soul: { amount: 1, probability: 0.25 }, shadow_soul: { amount: 1, probability: 0.25 } } },
