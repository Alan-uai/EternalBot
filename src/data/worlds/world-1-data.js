...
export const world1Data = {
  ...
  npcs: [
    { name: 'Kriluni', rank: 'E', exp: 1, hp: '5k', drops: { coins: { amount: 'x50', probability: 1 }, 'Dragon Race Token': { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x1', probability: 1 }, avatar: { probability: 0.01 } } },
    { name: 'Ymicha', rank: 'D', exp: 2, hp: '230k', drops: { coins: { amount: 'x100', probability: 1 }, 'Dragon Race Token': { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x2', probability: 1 }, avatar: { probability: 0.01 } } },
    { name: 'Tian Shan', rank: 'C', exp: 3, hp: '5M', drops: { coins: { amount: 'x150', probability: 1 }, 'Dragon Race Token': { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x3', probability: 1 }, avatar: { probability: 0.01 } } },
    { name: 'Kohan', rank: 'B', exp: 4, hp: '30M', drops: { coins: { amount: 'x200', probability: 1 }, 'Dragon Race Token': { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x4', probability: 1 }, avatar: { probability: 0.01 } } },
    { name: 'Picco', rank: 'A', exp: 5, hp: '100M', drops: { coins: { amount: 'x250', probability: 1 }, 'Dragon Race Token': { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x5', probability: 1 }, avatar: { probability: 0.01 } } },
    { name: 'Koku', rank: 'S', exp: 6, hp: '240M', drops: { coins: { amount: 'x300', probability: 1 }, 'Saiyan Evolution Token': { amount: 'x3-5', probability: 0.1 }, exp: { amount: 'x6', probability: 1 }, avatar: { probability: 0.01 } } },
