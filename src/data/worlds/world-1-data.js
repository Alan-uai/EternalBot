...
export const world1Data = {
  ...
  npcs: [
    ...
    { name: 'Tian Shan', rank: 'C', exp: 3, hp: '5M', drops: { coins: { amount: 'x150', probability: 1 }, dragon_race_token: { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x3', probability: 1 }, avatar_soul: { amount: 1, probability: 0.125 } } },
    { name: 'Kohan', rank: 'B', exp: 4, hp: '30M', drops: { coins: { amount: 'x200', probability: 1 }, dragon_race_token: { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x4', probability: 1 }, avatar_soul: { amount: 1, probability: 0.15 } } },
    { name: 'Picco', rank: 'A', exp: 5, hp: '100M', drops: { coins: { amount: 'x250', probability: 1 }, dragon_race_token: { amount: 'x1-5', probability: 0.1 }, exp: { amount: 'x5', probability: 1 }, avatar_soul: { amount: 1, probability: 0.20 } } },
    { name: 'Koku', rank: 'S', exp: 6, hp: '240M', drops: { coins: { amount: 'x300', probability: 1 }, saiyan_token: { amount: 'x3-5', probability: 0.1 }, exp: { amount: 'x6', probability: 1 }, avatar_soul: { amount: 1, probability: 0.25 } } },
    { name: 'Kid Kohan', rank: 'SS', exp: 15, hp: '2.5Qd', drops: { coins: { amount: 'x700', probability: 1 }, saiyan_token: { amount: 'x3-5', probability: 0.1 }, dragon_race_token: { amount: 'x3-5', probability: 0.1 }, exp: { amount: 'x15', probability: 1 }, avatar_soul: { amount: 1, probability: 0.5 }, four_star_hat: { probability: 0.25 }, luck_aura: { probability: 0.01 } }, videoUrl: 'https://cdn.discordapp.com/attachments/1430337273794265250/1430337506850902126/ScreenRecording_10-21-2025_10-29-41_1.mov?ex=68fa11dc&is=68f8c05c&hm=427738471ba4c03c65ded4771f410444eb190deb54be08eecc33c0ff00286c7f&' },
  ],
  pets: [
  ...
  dungeons: [
      ...
      { 
        ...
        achievements: {
            headers: ['Conquista', 'Requisito', 'Bônus'],
            rows: [
                { 'Conquista': 'Halloween Raid I', 'Requisito': 'Reach Wave 50', 'Bônus': '1% Dano' },
                { 'Conquista': 'Halloween Raid II', 'Requisito': 'Reach Wave 100', 'Bônus': '1% Energia' },
                { 'Conquista': 'Halloween Raid III', 'Requisito': 'Reach Wave 150', 'Bônus': '2% Dano' },
                { 'Conquista': 'Halloween Raid IV', 'Requisito': 'Reach Wave 200', 'Bônus': '2% Energia' },
                { 'Conquista': 'Halloween Raid V', 'Requisito': 'Reach Wave 250', 'Bônus': '3% Dano' },
                { 'Conquista': 'Halloween Raid VI', 'Requisito': 'Reach Wave 300', 'Bônus': '3% Energia' },
                { 'Conquista': 'Halloween Raid VII', 'Requisito': 'Reach Wave 350', 'Bônus': '4% Dano' },
                { 'Conquista': 'Halloween Raid VIII', 'Requisito': 'Reach Wave 400', 'Bônus': '4% Energia' },
                { 'Conquista': 'Halloween Raid IX', 'Requisito': 'Reach Wave 450', 'Bônus': '5% Dano' },
                { 'Conquista': 'Halloween Raid X', 'Requisito': 'Reach Wave 500', 'Bônus': '5% Energia' },
                { 'Conquista': 'Halloween Raid XI', 'Requisito': 'Reach Wave 550', 'Bônus': '6% Dano' },
                { 'Conquista': 'Halloween Raid XII', 'Requisito': 'Reach Wave 600', 'Bônus': '6% Energia' },
                { 'Conquista': 'Halloween Raid XIII', 'Requisito': 'Reach Wave 650', 'Bônus': '7% Dano' },
                { 'Conquista': 'Halloween Raid XIV', 'Requisito': 'Reach Wave 700', 'Bônus': '7% Energia' },
                { 'Conquista': 'Halloween Raid XV', 'Requisito': 'Reach Wave 750', 'Bônus': '8% Dano' },
                { 'Conquista': 'Halloween Raid XVI', 'Requisito': 'Reach Wave 800', 'Bônus': '8% Energia' },
                { 'Conquista': 'Halloween Raid XVII', 'Requisito': 'Reach Wave 850', 'Bônus': '9% Dano' },
                { 'Conquista': 'Halloween Raid XVIII', 'Requisito': 'Reach Wave 900', 'Bônus': '9% Energia' },
                { 'Conquista': 'Halloween Raid XIX', 'Requisito': 'Reach Wave 950', 'Bônus': '10% Dano' },
