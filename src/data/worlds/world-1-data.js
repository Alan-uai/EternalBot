...
export const world1Data = {
  ...
  npcs: [
    { name: 'Kriluni', rank: 'E', exp: 20, hp: '1k' },
    { name: 'Ymicha', rank: 'D', exp: 35, hp: '1.25k' },
    { name: 'Tian Shan', rank: 'C', exp: 50, hp: '1.5k' },
    { name: 'Picco', rank: 'B', exp: 75, hp: '2k' },
    { name: 'Koku', rank: 'A', exp: 100, hp: '2.5k' },
  ...
  pets: [
    { name: 'Kriluni', rarity: 'Comum', energy_bonus: '0.01x' },
    { name: 'Ymicha', rarity: 'Incomum', energy_bonus: '0.02x' },
    { name: 'Tian Shan', rarity: 'Raro', energy_bonus: '0.03x' },
    { name: 'Kohan', rarity: 'Épico', energy_bonus: '0.04x' },
    { name: 'Picco', rarity: 'Lendário', energy_bonus: '0.05x' },
    { name: 'Koku', rarity: 'Mítico', energy_bonus: '0.06x' },
    { name: 'Kid Kohan', rarity: 'Phantom', energy_bonus: '0.07x' },
  ],
  powers: [
    {
      name: 'Dragon Race',
