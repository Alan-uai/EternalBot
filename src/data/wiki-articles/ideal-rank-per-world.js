...
**Importante:** Esta é uma análise teórica. Bônus de poderes, armas, pets, gamepasses e outros multiplicadores irão acelerar drasticamente sua progressão e permitir que você avance com ranks mais baixos do que os listados. Use esta tabela como uma referência de poder base.`,
  ...
  tables: {
    idealRank: {
      ...
      rows: [
        { 'Mundo': 1, 'Chefe (Rank SS)': 'Kid Kohan', 'HP do Chefe': '2.5Qd', 'DPS (5 min kill)': '8.33T', 'Rank Ideal (Estimado)': '50-55' },
        { 'Mundo': 2, 'Chefe (Rank SS)': 'Shanks', 'HP do Chefe': '5.0sx', 'DPS (5 min kill)': '16.67Qn', 'Rank Ideal (Estimado)': '60-65' },
        { 'Mundo': 3, 'Chefe (Rank SS)': 'Eizen', 'HP do Chefe': '2.5Sp', 'DPS (5 min kill)': '8.33sx', 'Rank Ideal (Estimado)': '65-70' },
        { 'Mundo': 4, 'Chefe (Rank SS)': 'Sakuni', 'HP do Chefe': '120.0Sp', 'DPS (5 min kill)': '400sx', 'Rank Ideal (Estimado)': '70-75' },
        { 'Mundo': 5, 'Chefe (Rank SS)': 'Rangoki', 'HP do Chefe': '31.2de', 'DPS (5 min kill)': '104N', 'Rank Ideal (Estimado)': '85-90' },
        { 'Mundo': 6, 'Chefe (Rank SS)': 'Statue of God', 'HP do Chefe': '195Ud', 'DPS (5 min kill)': '650de', 'Rank Ideal (Estimado)': '90-95' },
        { 'Mundo': 7, 'Chefe (Rank SS)': 'Novi Chroni', 'HP do Chefe': '101TdD', 'DPS (5 min kill)': '336DD', 'Rank Ideal (Estimado)': '95-100' },
        { 'Mundo': 8, 'Chefe (Rank SS)': 'Itechi/Madera', 'HP do Chefe': '~4.2QnD', 'DPS (5 min kill)': '14tdD', 'Rank Ideal (Estimado)': '100-105' },
        { 'Mundo': 9, 'Chefe (Rank SS)': 'Veggita', 'HP do Chefe': '2.46OcD', 'DPS (5 min kill)': '8.2SpD', 'Rank Ideal (Estimado)': '105-110' },
        { 'Mundo': 10, 'Chefe (Rank SS)': 'Ken Turbo', 'HP do Chefe': '494SxD', 'DPS (5 min kill)': '1.65SpD', 'Rank Ideal (Estimado)': '105-110' },
        { 'Mundo': 11, 'Chefe (Rank SS)': 'Killas Godspeed', 'HP do Chefe': '49.4Vgn', 'DPS (5 min kill)': '164NvD', 'Rank Ideal (Estimado)': '110-115' },
        { 'Mundo': 12, 'Chefe (Rank SS)': 'Garou Cósmico', 'HP do Chefe': '2.96DVg', 'DPS (5 min kill)': '9.8Uvg', 'Rank Ideal (Estimado)': '115-120' },
        { 'Mundo': 13, 'Chefe (Rank SS)': 'Esanor/Number 8', 'HP do Chefe': '~7.6DVg', 'DPS (5 min kill)': '25Uvg', 'Rank Ideal (Estimado)': '120-125' },
        { 'Mundo': 14, 'Chefe (Rank SS)': 'Valzora', 'HP do Chefe': '4.79SeV', 'DPS (5 min kill)': '16QnV', 'Rank Ideal (Estimado)': '120-125' },
