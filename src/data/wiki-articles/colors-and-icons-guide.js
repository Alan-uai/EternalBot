  ...
  tables: {
    ...
    statusIcons: {
      ...
      rows: [
        ...
        { Ícone: '🪙 (Moeda com Símbolo)', Significado: 'Token', Descrição: 'Item usado para leveling ou crafting.' },
        ...
        { Ícone: '⚡ (Raio)', Bônus: 'Energia', Descrição: 'Bônus permanente de Energia.' },
        { Ícone: '🥊 (Luva de Boxe)', Bônus: 'Dano', Descrição: 'Bônus permanente de Dano.' },
        { Ícone: '🪙 (Moeda)', Bônus: 'Moedas (Coins)', Descrição: 'Bônus permanente de Moedas.' },
        { Ícone: '⭐ / 🍀 (Estrela / Trevo)', Bônus: 'Sorte (Luck)', Descrição: 'Bônus permanente de Sorte.' },
      ],
    },
  },
};
